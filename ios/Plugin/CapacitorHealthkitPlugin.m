...
CAP_PLUGIN(CapacitorHealthkitPlugin, "CapacitorHealthkit",
           ...
           CAP_PLUGIN_METHOD(queryHKitSampleTypeAnchored, CAPPluginReturnPromise);
           CAP_PLUGIN_METHOD(isAvailable, CAPPluginReturnPromise);
           CAP_PLUGIN_METHOD(queryAggregatedDailySampleType, CAPPluginReturnPromise);
           CAP_PLUGIN_METHOD(queryAggregatedDailySampleTypeAnchored, CAPPluginReturnPromise);
